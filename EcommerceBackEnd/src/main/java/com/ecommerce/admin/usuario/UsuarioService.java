...
public class UsuarioService {
	...
	public Usuario getUsuarioPorEmail(String email) {
		return usuarioRepo.getUsuarioPeloEmail(email);
	}

	public Usuario atualizarConta(Usuario usuarioFormulario) {
		Usuario usuarioBD = usuarioRepo.findById(usuarioFormulario.getId()).get();
		
		if(!usuarioFormulario.getSenha().isEmpty()) {
			usuarioBD.setSenha(usuarioFormulario.getSenha());
			codificarSenha(usuarioBD);
		}
		
		usuarioBD.setNome(usuarioFormulario.getNome());
